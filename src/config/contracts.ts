...
export const RPC_URL = import.meta.env.VITE_RPC_URL || 'https://testnet.sentry.tm.injective.network:443';
export const REST_URL = import.meta.env.VITE_REST_URL || 'https://testnet.sentry.lcd.injective.network:443';
...
export const EXCHANGE_RATE = parseInt(import.meta.env.VITE_EXCHANGE_RATE || '100');
